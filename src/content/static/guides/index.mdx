...
| :---- | :---- | :---- |
| Sandbox | Available to everyone via test credentials. Contains test claims data. | [https://sandbox.bluebutton.cms.gov/v3/fhir/](https://sandbox.bluebutton.cms.gov/v3/fhir/)  |
| Production | Must complete steps for production credentials. Contains real Medicare enrollee data | [https://api.bluebutton.cms.gov/v3/fhir/](https://api.bluebutton.cms.gov/v3/fhir/)  |
