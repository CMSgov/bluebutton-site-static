...
<Alert size="slim" variant="success">**Tip:** Short, contextual messages in your UI are far more effective than burying this information in a privacy policy. A quick "We're about to request your Medicare claims data so we can show you your health spending history" goes a long way.</Alert>
...
1. **From Medicare.gov** In the ["My Connected Apps"](https://www.medicare.gov/my/connected-apps) section of their Medicare.gov account  
...
curl -X POST "https://api.bluebutton.cms.gov/v3/o/revoke/" \
...
> **Connect your Medicare account** We'll request access to your Medicare claims data, including doctor visits, hospital stays, and prescriptions from the last 3 years.
>
> We use this data to [your specific use case]. We don't share your data with third parties.
>
> You can disconnect at any time from your [Medicare Connected Apps page](https://www.medicare.gov/my/connected-apps). [Connect to Medicare] [Learn more]
...
For the full requirements, see [How to write your privacy policy](/production-access/how-to-write-privacy-policy/).
