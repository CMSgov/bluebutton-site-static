...
The response is paginated: 10 claims per page by default. See [Handling Pagination](/guides/handling-pagination/).
...
Look up all adjudication codes in the [Code Systems](/data/code-systems/) page.
...
For the complete field reference, see the [ExplanationOfBenefit endpoint](https://sandbox.bluebutton.cms.gov/docs/openapi#/v3/listReadViewExplanationOfBenefits_v3) page.
