...
A patient may have multiple MBIs (current and historic). Use the `identifier-currency` extension to determine which is current. See [fetching patient data](#guides/fetching-patient-data.mdx) for details and code examples.
