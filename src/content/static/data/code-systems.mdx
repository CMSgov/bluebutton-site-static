...
The Blue Button API also provides data in [FHIR Extensions](https://www.hl7.org/fhir/extensibility.html) . FHIR extensions are custom data elements that are not found in the FHIR standard. Check the [data dictionary](https://bluebutton.cms.gov/data-dictionary/) for further details.  
