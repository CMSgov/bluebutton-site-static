...
When you apply for production access, confirm your terms of service cover all requirements listed in the Blue Button API Terms of Service. Be sure you have read the [Blue Button API Terms of Service](https://bluebutton.cms.gov/terms/)  and checked your own terms of service against them.
...
* Be easy to read, especially from a Medicare enrollee's perspective.   
  ...
  * You can use a free editor such as [Hemingway App](https://hemingwayapp.com/) to verify its readability  
...
* Restricts users from requesting, accessing, using, or sharing a Medicare enrollee's [Medicare.gov](https://Medicare.gov) login credentials
...
1. Submit drafts of the new document and a draft notification to enrollees by emailing [BlueButtonAPI@cms.hhs.gov](mailto:BlueButtonAPI@cms.hhs.gov).  
