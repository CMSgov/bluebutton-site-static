...
Changes include the element name, description, FHIRPath expressions, and other information, such as which Code Systems are applicable (for CMS-specific terminology). View the [Data Dictionary](https://bluebutton.cms.gov/data-dictionary/) to explore changes to individual data elements.
