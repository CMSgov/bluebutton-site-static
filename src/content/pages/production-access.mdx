...
<ProcessList class="production-access-process-list">
  <ProcessListItem heading="Read the terms of service">
  ...
  <ProcessListItem heading="Develop your application in the sandbox">
  ...
  <ProcessListItem heading="Draft your privacy policy and terms of service">
    ...
    <AccordionList>
      <AccordionItem heading="How to use your privacy policy and terms of service">
      ...
      <AccordionItem heading="Privacy Policy">
...
{/* This section below is composed of links that are redundant under the new IA. Recommend removing */}
...
- Start building your app with our Node and Python [SDKs and sample apps](/api-docs/developer-sandbox#sdks).
