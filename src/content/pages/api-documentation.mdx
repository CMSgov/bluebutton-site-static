...
Medicare enrollees may always opt to omit personal data such as name, date of birth, race, and sex when granting access to claims data. An enrollee's choice during the BB2.0 authorization flow determines the [scope](/authorization#scopes) of access an application will have to their data. 
...
We currently maintain production and sandbox environments for developing with the BB2.0 API. For technical information about our environments, see [Base FHIR URLs](/calling-the-api#base-fhir-urls). 
