...
We currently maintain production and sandbox environments for developing with the Blue Button API. For technical information about our environments, see [Base FHIR URLs](/api-documentation/calling-the-api#base-fhir-urls). 
