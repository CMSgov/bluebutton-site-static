...
<table class="usa-table usa-table--borderless usa-table--stacked margin-bottom-4">
  ...
  <tbody>
    <tr>
      <td><code>BBUser00000</code> to <code>BBUser09999</code></td>
    ...
    <tr>
      <td><code>BBUser10000</code></td>
      <td>Last Updated 2022</td>
      <td><code>BBUser10000</code> is a special synthetic user that provides nearly every field the API supports, including a variety of claim types. This makes it an excellent testing account for populating test scenarios.</td>
    </tr>
  </tbody>
</table>
