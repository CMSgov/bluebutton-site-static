...
The BB2.0 database pulls data from the [CMS Chronic Conditions Warehouse (CCW)](https://www2.ccwdata.org/web/guest/home/), which contains Medicare Part A, B and D claims data going back to 2014. 
