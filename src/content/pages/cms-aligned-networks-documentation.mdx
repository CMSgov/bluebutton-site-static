...
| Element | Optionality | Requirement |
| :---- | :---- | :---- |
| `iss` | required | <ul><li>**Production**: Must be `https://api.id.me/oidc` or `https://verified.clearme.com/integrations`</li><li>**Lower environments**: Must be `https://api.idmelabs.com/oidc` or \<clear one here\></li></ul>  |
