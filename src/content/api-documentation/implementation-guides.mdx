...
seo: 
  description: "Access HL7 FHIR implementation guides for the Blue Button API including CARIN Alliance Common Payer Consumer Data Set (CPCDS) and v2 artifacts"
sortOrder: 7
---
