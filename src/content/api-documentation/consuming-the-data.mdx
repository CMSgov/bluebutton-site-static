...
For complete implementation guidance, see the [FHIR specification](http://www.hl7.org/fhir/index.html) and the [CARIN implementation guide](http://www.hl7.org/fhir/us/carin-bb/index.html). Our [Resources page](/bb2-data/resources/) also includes links to tutorials and helpful information on FHIR.
