...
seo: 
  description: "Learn how to process Blue Button API FHIR data including bundles, pagination, identifiers, references, extensions, and claim type determination for Medicare data"
sortOrder: 4
---
