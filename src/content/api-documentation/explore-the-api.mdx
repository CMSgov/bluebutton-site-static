...
3. Log in to Medicare.gov using a [synthetic user's account credentials](/bb2-data/understanding-the-data/#authenticating-as-a-synthetic-user).
4. Click **Connect**.  
...
To learn more about Blue Button API data, refer to [Understanding the Data](/bb2-data/understanding-the-data/).
