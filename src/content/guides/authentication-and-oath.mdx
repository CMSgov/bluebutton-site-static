...
## Get an authorization code (EXISTING UPDATED CONTENT) 
...
## Exchange the code for a token (EXISTING UPDATED CONTENT)
...
## Scopes (EXISTING UPDATED CONTENT)
## Scopes (EXISTING UPDATED CONTENT) ✅
...
| Scope | Permission |
| :---- | :---- |
| patient/Patient.rs or patient/Patient.read patient/Patient.rs | Read and search my patient's general and demographic information |
...
To re-authorize, follow the same flow described under Get an authorization code.
