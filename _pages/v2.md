...
**(Writer's note) Blue Button 2.0 is rolling out API v2, v2 adds support of FHIR R4 and CARIN Compliance vs. v1, this document is revised from Blue Button API 2.0 Developer Documentation Site section "Try the API" at Blue Button 2.0 API Docs - Try the API, to cover both STU3/v1 and R4/v2.**

**Before GA (General Availability) of v2, only selected applications whose owner users are member of BB2 Admin User Group "BFDV2Partners" can access FHIR resources through v2 API.**
...
for v2: [https://sandbox.bluebutton.cms.gov/v2/fhir/Patient/-20140000008325](https://sandbox.bluebutton.cms.gov/v1/fhir/Patient/-20140000008325)
...
for v2:[https://sandbox.bluebutton.cms.gov/v2/o/authorize/](https://sandbox.bluebutton.cms.gov/v1/o/authorize/)

**Access Token URL:**

for v1: https://sandbox.bluebutton.cms.gov/v1/o/token/

for v2: [https://sandbox.bluebutton.cms.gov/v2/o/token/](https://sandbox.bluebutton.cms.gov/v1/o/token/)
...
**James : checked current claims for SAMPLE\_A (patient id: -20140000008325, the numbers are as follows:**
...
ofor v1 [https://sandbox.bluebutton.cms.gov/v1/o/authorize/](https://sandbox.bluebutton.cms.gov/v1/o/authorize/)

ofor v2 [https://sandbox.bluebutton.cms.gov/v2/o/authorize/](https://sandbox.bluebutton.cms.gov/v1/o/authorize/)
...
[_ **https://protocol** _](https://protocol/)
...
| --- | --- |
| v1 | [https://sandbox.bluebutton.cms.gov/v1/o/authorize/?client\_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2](https://sandbox.bluebutton.cms.gov/v1/o/authorize/?client_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2) &amp;redirect\_uri=[http://localhost:8080/testclient/callback](http://localhost:8080/testclient/callback) &amp;response\_type=code &amp;state=8e896a59f0744a8e93bf2f1f13230be5 |
| v2 | [https://sandbox.bluebutton.cms.gov/v2/o/authorize/?client\_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2](https://sandbox.bluebutton.cms.gov/v1/o/authorize/?client_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2) &amp;redirect\_uri=[http://localhost:8080/testclient/callback](http://localhost:8080/testclient/callback) &amp;response\_type=code &amp;state=8e896a59f0744a8e93bf2f1f13230be5 |
{:.ds-c-table}
...
For example if the redirect\_uri is [http://localhost:8080/testclient/callback](http://localhost:8080/testclient/callback) BlueButton will redirect with this request.
...
| **API version** | **Request URL** |
| --- | --- |
| v1 | curl -X POST "[https://sandbox.bluebutton.cms.gov/v1/o/token/](https://sandbox.bluebutton.cms.gov/v1/o/token/)" \ -u "swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2:\&lt;client\_secret\&gt;" \ -d "code=TSjqiZCdJwGyytGjz2GzziPfHTJ6z2 &amp;grant\_type=authorization\_code &amp;redirect\_uri=[http://localhost/testclient/callback](http://localhost/testclient/callback)" |
| v2 | curl -X POST "[https://sandbox.bluebutton.cms.gov/v2/o/token/](https://sandbox.bluebutton.cms.gov/v1/o/token/)" \ -u "swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2:\&lt;client\_secret\&gt;" \ -d "code=TSjqiZCdJwGyytGjz2GzziPfHTJ6z2 &amp;grant\_type=authorization\_code &amp;redirect\_uri=[http://localhost/testclient/callback](http://localhost/testclient/callback)" |
{:.ds-c-table}
...
| **API version** | **Request URL** |
| --- | --- |
| v1 | [https://sandbox.bluebutton.cms.gov/v1/o/authorize/?client\_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2](https://sandbox.bluebutton.cms.gov/v1/o/authorize/?client_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2) &amp;redirect\_uri=[http://localhost:8080/testclient/callback](http://localhost:8080/testclient/callback) &amp;response\_type=token &amp;state=8e896a59f0744a8e93bf2f1f13230be5 |
| v2 | [https://sandbox.bluebutton.cms.gov/v2/o/authorize/?client\_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2](https://sandbox.bluebutton.cms.gov/v1/o/authorize/?client_id=swBu7LWsCnIRfu530qnfPw1y5vMmER3lAM2L6rq2) &amp;redirect\_uri=[http://localhost:8080/testclient/callback](http://localhost:8080/testclient/callback) &amp;response\_type=token &amp;state=8e896a59f0744a8e93bf2f1f13230be5 |
{:.ds-c-table}
...
| --- | --- |
| v1 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?patient=-20140000008325](https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?patient=-20140000008325)" |
| v2 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/?patient=-20140000008325](https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?patient=-20140000008325)" |
{:.ds-c-table}
...
| **API version** | **CURL command** |
| --- | --- |
| v1 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v1/fhir/Patient/-20140000008325](https://sandbox.bluebutton.cms.gov/v1/fhir/Patient/-20140000008325)" |
| v2 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v2/fhir/Patient/-20140000008325](https://sandbox.bluebutton.cms.gov/v1/fhir/Patient/-20140000008325)" |
{:.ds-c-table}
...
| **API version** | **CURL command** |
| --- | --- |
| v1 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v1/fhir/Coverage/?beneficiary=-20140000008325](https://sandbox.bluebutton.cms.gov/v1/fhir/Coverage/?beneficiary=-20140000008325)" |
| v2 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v2/fhir/Coverage/?beneficiary=-20140000008325](https://sandbox.bluebutton.cms.gov/v1/fhir/Coverage/?beneficiary=-20140000008325)" |
{:.ds-c-table}
...
| **API version** | **CURL command** |
| --- | --- |
| v1 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v1/connect/userinfo](https://sandbox.bluebutton.cms.gov/v1/connect/userinfo)" |
| v2 | curl --header "Authorization: Bearer AUTHORIZATION TOKEN" "[https://sandbox.bluebutton.cms.gov/v2/connect/userinfo](https://sandbox.bluebutton.cms.gov/v1/connect/userinfo)" |
{:.ds-c-table}
...
| **API version** | **Request** |
| --- | --- |
| v1 | [https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/](https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/) |
| v2 | [https://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/](https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/) |
...
| **API version** | **Request** |
| --- | --- |
| v1 | https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?type=carrierOrhttps://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?type=https://bluebutton.cms.gov/resources/codesystem/eob-type|carrier |
| v2 | https://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/?type=carrierOrhttps://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/?type=https://bluebutton.cms.gov/resources/codesystem/eob-type|carrier |
{:.ds-c-table}
...
| **API version** | **Request** |
| --- | --- |
| v1 | https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?type=inpatientOrhttps://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?type=https://bluebutton.cms.gov/resources/codesystem/eob-type|inpatient |
| v2 | https://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/?type=inpatientOrhttps://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/?type=https://bluebutton.cms.gov/resources/codesystem/eob-type|inpatient |
{:.ds-c-table}
...
| **API verion** | **Request** |
| --- | --- |
| v1 | https://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?type=pdeOrhttps://sandbox.bluebutton.cms.gov/v1/fhir/ExplanationOfBenefit/?type=https://bluebutton.cms.gov/resources/codesystem/eob-type|pde |
| v2 | https://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/?type=pdeOrhttps://sandbox.bluebutton.cms.gov/v2/fhir/ExplanationOfBenefit/?type=https://bluebutton.cms.gov/resources/codesystem/eob-type|pde |
{:.ds-c-table}
