...
See also the note about [version specific extensions](https://www.hl7.org/fhir/versions.html#extensions){:target="_blank"}. (This analysis is available as [JSON](https://hl7.org/fhir/R4/json.html){:target="_blank"} from HL7 (note: this includes all R4 data).
