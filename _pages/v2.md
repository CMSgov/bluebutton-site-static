...
<div class="ds-c-alert">
	<div class="ds-c-alert__body">
		...
		<p class="ds-c-alert__text">
			If needed, <a href="/documentation/">documentation for the STU3 (v1) implementation</a> of the Blue Button API is available. 
		</p>
	</div>
</div>
...
This equated to an oauthtester subdomain for the [bluebutton.cms.gov](/developers) domain.
...
The Blue Button 2.0 API team has created a Blue Button 2.0 API Implementation Guide (BB2IG). You can access the guide here: [Blue Button 2.0 API Implementation Guide](/assets/ig/index.html).

The BB2IG features nine profiles in this version of the guide:

- [Blue Button 2.0 API Patient Profile](/assets/ig/StructureDefinition-bluebutton-patient-claim.html)
- [Blue Button 2.0 API Carrier Claim Profile](/assets/ig/StructureDefinition-bluebutton-carrier-claim.html)
- [Blue Button 2.0 API DME Claim Profile](/assets/ig/StructureDefinition-bluebutton-dme-claim.html)
- [Blue Button 2.0 API HHA Claim Profile](/assets/ig/StructureDefinition-bluebutton-hha-claim.html)
- [Blue Button 2.0 API Hospice Claim Profile](/assets/ig/StructureDefinition-bluebutton-hospice-claim.html)
- [Blue Button 2.0 API Inpatient Claim Profile](/assets/ig/StructureDefinition-bluebutton-inpatient-claim.html)
- [Blue Button 2.0 API Outpatient Claim Profile](/assets/ig/StructureDefinition-bluebutton-outpatient-claim.html)
- [Blue Button 2.0 API Part D Event Profile](/assets/ig/StructureDefinition-bluebutton-pde-claim.html)
- [Blue Button 2.0 API SNF Claim Profile](/assets/ig/StructureDefinition-bluebutton-snf-claim.html)
