...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ExplanationOfBenefit">
      ...
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prpayamt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prpayamt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prpayamt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prpayamt-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-num-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-num-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-num-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-num-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-asgmntcd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-asgmntcd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-asgmntcd-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-asgmntcd-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-cash-ddctbl-apld-amt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-cash-ddctbl-apld-amt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-cash-ddctbl-apld-amt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-cash-ddctbl-apld-amt-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-pmt-dnl-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-pmt-dnl-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-pmt-dnl-cd-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-carr-clm-pmt-dnl-cd-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-alowd-amt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-alowd-amt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-alowd-amt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-alowd-amt-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-sbmtd-chrg-amt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-sbmtd-chrg-amt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-sbmtd-chrg-amt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-carr-clm-sbmtd-chrg-amt-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-bene-pmt-amt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-bene-pmt-amt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-bene-pmt-amt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-bene-pmt-amt-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-prvdr-pmt-amt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-prvdr-pmt-amt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-prvdr-pmt-amt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-nch-clm-prvdr-pmt-amt-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-clm-clncl-tril-num-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-clm-clncl-tril-num-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-clm-clncl-tril-num-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-clm-clncl-tril-num-extension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ExplanationOfBenefit/f:careTeam">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prtcptng-ind-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prtcptng-ind-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prtcptng-ind-cd-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prtcptng-ind-cd-extension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ExplanationOfBenefit/f:item">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-mtus-cnt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-mtus-cnt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-mtus-cnt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-mtus-cnt-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-betos-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-betos-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-betos-cd-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-betos-cd-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-bene-prmry-pyr-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-bene-prmry-pyr-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-bene-prmry-pyr-cd-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-bene-prmry-pyr-cd-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-service-deductible-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-service-deductible-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-service-deductible-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-service-deductible-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-hct-hgb-rslt-num-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-hct-hgb-rslt-num-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-hct-hgb-rslt-num-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-hct-hgb-rslt-num-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-ndc-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-ndc-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-ndc-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-ndc-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-suplrnum-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-suplrnum-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-suplrnum-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-suplrnum-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-scrn-svgs-amt-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-scrn-svgs-amt-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-scrn-svgs-amt-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-scrn-svgs-amt-extension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ExplanationOfBenefit/f:item/f:locationCodeableConcept">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prvdr-state-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-prvdr-state-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-prcng-state-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-prcng-state-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-supplr-type-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-dmerc-line-supplr-type-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 0">text: maximum cardinality of 'text' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ExplanationOfBenefit/f:item/f:adjudication">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-pmt-80-100-cd-extension']) &gt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-pmt-80-100-cd-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-pmt-80-100-cd-extension']) &lt;= 1">extension with URL = 'https://bluebutton.cms.gov/assets/ig/StructureDefinition-bluebutton-dme-line-pmt-80-100-cd-extension': maximum cardinality of 'extension' is 1</sch:assert>
